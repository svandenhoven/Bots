...
namespace ControllerSample.Notifications
{
    public class NotificationSender
    {
        ...
        /// <returns></returns>
        public async Task<ResourceResponse> NotifyAsync(IList<Party> partiesToNotify, string message, string prio)
        {
            ...
            {
                case "high":
                    notification.Priority = NotificationPriorityOptions.High;
                    break;
                case "normal":
                    notification.Priority = NotificationPriorityOptions.Normal;
                    break;
                case "low":
                    notification.Priority = NotificationPriorityOptions.Low;
                    break;
                default:
                    notification.Priority = NotificationPriorityOptions.Normal;
                    break;
